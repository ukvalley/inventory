...
@section('breadcrumbs')
    <li class="breadcrumb-item active"><a href="{{ route("admin.sim_types.index") }}">Sim Types</a></li>
    @if(isset($data))
...
@endsection
@section('backBtn')
<a href="{{ route("admin.sim_types.index") }}"><i class="fas fa-angle-left"></i> {{trans('admiko.page_back_btn')}}</a>
@endsection
@section('content')
        ...
        <div class="card-footer form-actions" id="form-group-buttons">
            <div class="row">
                ...
                <div class="col-sm-10">
                    ...
                    <a href="{{ route("admin.sim_types.index") }}" class="btn btn-secondary float-end" role="button">{{trans('admiko.table_cancel')}}</a>
                </div>
            </div>
        </div>
    </form>
