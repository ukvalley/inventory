            ...
            <div class="row">
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <div class="input-group" id="datePicker_date_time" data-target-input="nearest">
                                <input type="text" autocomplete="off" style="max-width: 170px;border-right: unset;"
                                       ...
                                       data-target="#datePicker_date_time"  id="date_time" data-toggle="datetimepicker"
                                       placeholder="Date &amp; Time" name="date_time" value="{{{ old('date_time', isset($data)?$data->date_time : '') }}}">
                                <div class="input-group-append input-group-text" data-target="#datePicker_date_time" data-toggle="datetimepicker">
