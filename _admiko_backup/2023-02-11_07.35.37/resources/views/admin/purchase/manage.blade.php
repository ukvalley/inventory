    ...
    <form method="POST" action="{{ $admiko_data['formAction'] }}" enctype="multipart/form-data" class="needs-validation" novalidate>
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        <label for="manufacturer_by" class="col-md-2 col-form-label">Manufactured By:</label>
                        <div class="col-md-10">
                            <input type="text" class="form-control" id="manufacturer_by" name="manufacturer_by"  placeholder="Manufactured By"  value="{{{ old('manufacturer_by', isset($data)?$data->manufacturer_by : '') }}}">
                            <div class="invalid-feedback @if ($errors->has('manufacturer_by')) d-block @endif">{{trans('admiko.required_text')}}</div>
                            <small id="manufacturer_by_help" class="text-muted"></small>
                        </div>
                    </div>
                </div>
                <div class=" col-12">
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        <label for="user_id1" class="col-md-2 col-form-label">User Id:</label>
                        <div class="col-md-10">
                            <select class="form-select" id="user_id1" name="user_id1" >
                                <option value="">{{trans("admiko.select")}}</option>
                                @foreach($users_all as $id => $value)
                                    <option value="{{ $id }}" {{ (old('user_id1') ? old('user_id1') : $data->user_id1 ?? '') == $id ? 'selected' : '' }}>{{ $value }}</option>
                                @endforeach
                            </select>
                            <div class="invalid-feedback @if ($errors->has('user_id1')) d-block @endif">{{trans('admiko.required_text')}}</div>
                            <small id="user_id1_help" class="text-muted"></small>
                        </div>
                    </div>
                </div>
