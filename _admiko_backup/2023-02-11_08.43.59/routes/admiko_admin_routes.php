...
/**Manifacturer**/
Route::delete("manifacturer/destroy", [ManifacturerController::class,"destroy"])->name("manifacturer.delete");
Route::resource("manifacturer", ManifacturerController::class)->parameters(["manifacturer" => "manifacturer"]);
