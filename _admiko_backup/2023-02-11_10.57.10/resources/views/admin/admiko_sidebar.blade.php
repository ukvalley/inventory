...
<li class="nav-item{{ $admiko_data['sideBarActive'] === "transaction" ? " active" : "" }}"><a class="nav-link" href="{{route('admin.transaction.index')}}"><i class="fas fa-file-alt fa-fw"></i>Transaction</a></li>
@endIf
@if(Gate::any(['manifacturer_allow', 'manifacturer_edit']))
<li class="nav-item{{ $admiko_data['sideBarActive'] === "manifacturer" ? " active" : "" }}"><a class="nav-link" href="{{route('admin.manifacturer.index')}}"><i class="fas fa-file-alt fa-fw"></i>Manifacturer</a></li>
@endIf