...
class PurchaseController extends Controller
{
    ...
    public function create()
    {
        ...
        return view("admin.purchase.manage")->with(compact('admiko_data','device_status_all','sim_types_all','users_all','customer_all','manifacturer_all'));
    }
    ...
    public function edit($id)
    {
		...
		$manifacturer_all = Manifacturer::all()->sortBy("name")->pluck("name", "id");
        $data = $Purchase;
        return view("admin.purchase.manage")->with(compact('admiko_data', 'data','device_status_all','sim_types_all','users_all','customer_all','manifacturer_all'));
    }
