@include('users.common.userheader') <style>
  h4 {
    font-weight: 600;
    font-size: 13px;
    color: black
...
<div class="content-wrapper">
    ...
    <div class="row">
      ...
      <div class="col-sm-8">
        <div class="panel panel-bd lobidrag">
          ...
          <a class="btn btn-warning " href="{{route('/user/pdfview_device_info',['download'=>'pdf']) }}" >Export to PDF</a>
  ...
  <!-- /.content -->
</div> @include('users.common.footer')