         ...
         <aside class="main-sidebar">
            ...
            <div class="sidebar">
               ...
               <ul class="sidebar-menu">
                  <li class="active">
                     <a href="{{url('/')}}/user/Userdashboard"><i class="fa fa-tachometer"></i><span>Dashboard</span>
                   ...
                   <li class="treeview">
                     ...
                     <li><a href="{{url('/')}}/user/customer1/customer_table">Show Customer</a></li>
                         <li><a href="{{url('/')}}/user/customer1/register_customer">Add New Customer</a></li>
                         <li><a href="{{url('/')}}/user/vehicle/vehicle_table">Show Vehicle</a></li>
                        <li><a href="{{url('/')}}/user/vehicle/register_vehicle">Add New Vehicle</a></li>
                        <li><a href="{{url('/')}}/user/manifacturer1/manifacturer_table">Show Manifacturers</a></li>
                  ...
                  <li class="treeview">
                     ...
                     <ul class="treeview-menu">
                        <li><a href="{{url('/')}}/user/device1/device_table">Show Device</a></li>
                  ...
                  <li class="treeview">
                     ...
                     <ul class="treeview-menu">
                        <li><a href="{{url('/')}}/user/device_sale">Sale Device</a></li>
                        <li><a href="{{url('/')}}/user/sale/sales_table">Show Sale Device</a></li>
                  ...
                  <li class="treeview">
                     ...
                     <ul class="treeview-menu" >
                        <li><a href="{{url('/')}}/user/customer1/customer_table">Customer</a></li>
                        <li><a href="{{url('/')}}/user/vehicle/vehicle_table">Vehicle</a></li>
                        <li><a href="{{url('/')}}/user/user1/user_table">User</a></li>
                        <li><a href="{{url('/')}}/user/device/device_table">Device</a></li>
                        <li><a href="{{url('/')}}/user/purchase1/purchase_table">Purchase</a></li>
                        <li><a href="{{url('/')}}/user/sale/sales_table">Sales</a></li>
                         <!-- <li><a href="/records/records_table">Records</a></li> -->
                         <li><a href="{{url('/')}}/user/sim/sim_table">Sim Types</a></li>
                         <li><a href="{{url('/')}}/user/manifacturer1/manifacturer_table">Manifacturer</a></li>
                         <li><a href="{{url('/')}}/user/transaction1/transaction_table">Transaction</a></li>
                         <li><a href="{{url('/')}}/user/device_sale">Device Sale</a></li>
                         <li><a href="{{url('/')}}/user/purchase1/purchase_table">Purchase Table</a> </li>
                         <li><a href="{{url('/')}}/user/sale/sales_table">Sales Table</a></li>
                     </ul>
                  </li>
