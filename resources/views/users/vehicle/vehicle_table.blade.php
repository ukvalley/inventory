  ...
  @foreach($data as $row)
            <tr>
               ...
               <td><a href="{{url('/')}}/vehicle_info?id={{$row->id }}">{{$row->id }}</td>
                ...
                <td><a href="{{url('/')}}/user/vehicle_info?id={{$row->id }}">
                <a href="{{url('/')}}/user/vehicle/vehicle_edit?id={{$row->id}}" class="btn btn-primary">Edit</a>
                </td>
                <td>
                <a href="{{url('/')}}/user/vehicle_destroy?id={{$row->id}}" class="btn btn-danger">Delete</a>
                </td>
