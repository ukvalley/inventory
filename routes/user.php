...
Route::group(['prefix' => 'user', 'middleware' => ['is_user']], function(){
    ...
    Route::get('/user1/user_table', [UserController::class, 'view_user'])->name('view_user');
    
    //devices--------------------------------------------------------------------------------------------------
    
    // Route::get('add_device', [DeviceController::class, 'add_sim'])->name('add_sim');
    
    Route::get('device1/add_device',[DeviceController::class, 'add_device'])->name('add_device');
...
Route::put('/device-transfers/{transfer}/reject', [TransactionController::class, 'reject']);
    ...
    Route::get('/users.userdashboard', function () {
